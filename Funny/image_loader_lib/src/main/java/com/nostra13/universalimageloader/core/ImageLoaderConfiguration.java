...
import com.nostra13.universalimageloader.cache.memory.bitmapmemory.impl.FuzzyKeyMemoryCache;
import com.nostra13.universalimageloader.cache.memory.gifmemory.GifMemoryCache;
import com.nostra13.universalimageloader.cache.memory.gifmemory.impl.FuzzyKeyGifMemoryCache;
...
public final class ImageLoaderConfiguration {
	...
	final GifMemoryCache gifMemoryCache;
	...
	private ImageLoaderConfiguration(final Builder builder) {
		...
		gifMemoryCache = builder.gifMemoryCache;
	...
	public static class Builder {
		...
		private static final String WARNING_OVERLAP_GIF_MEMORY_CACHE = "memoryCache() and gif memoryCacheSize() calls overlap each other";
		...
		private GifMemoryCache gifMemoryCache = null;
		...
		public Builder memoryCacheSize(int memoryCacheSize) {
			...
			if (gifMemoryCache != null){
			    L.w(WARNING_OVERLAP_GIF_MEMORY_CACHE);
			}
		...
		public Builder gifmemoryCache(GifMemoryCache gifMemoryCache) {
		    if (memoryCacheSize != 0) {
		        L.w(WARNING_OVERLAP_MEMORY_CACHE);
		    }
		...
		private void initEmptyFieldsWithDefaultValues() {
			...
			if (gifMemoryCache == null) {
			    gifMemoryCache = DefaultConfigurationFactory.createGifMemoryCache(memoryCacheSize);
			}
			if (denyCacheImageMultipleSizesInMemory) {
				memoryCache = new FuzzyKeyMemoryCache(memoryCache, MemoryCacheUtils.createFuzzyKeyComparator());
				gifMemoryCache = new FuzzyKeyGifMemoryCache(gifMemoryCache, MemoryCacheUtils.createFuzzyKeyComparator());
			}
			if (downloader == null) {
