...
import com.nostra13.universalimageloader.cache.memory.bitmapmemory.impl.LruMemoryCache;
import com.nostra13.universalimageloader.cache.memory.gifmemory.GifMemoryCache;
import com.nostra13.universalimageloader.cache.memory.gifmemory.impl.LruGifMemoryCache;
...
public class DefaultConfigurationFactory {
	...
	public static GifMemoryCache createGifMemoryCache(int memoryCacheSize) {
	    if (memoryCacheSize == 0) {
	        memoryCacheSize = (int) (Runtime.getRuntime().maxMemory() / 8);
	    }
	    return new LruGifMemoryCache(memoryCacheSize);
	}
