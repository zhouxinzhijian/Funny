 ...
 * @since 1.0.0
 */
public class FuzzyKeyGifMemoryCache implements GifMemoryCache {

	private final GifMemoryCache cache;
	private final Comparator<String> keyComparator;

	public FuzzyKeyGifMemoryCache(GifMemoryCache cache, Comparator<String> keyComparator) {
		this.cache = cache;
