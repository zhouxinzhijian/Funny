...
public class CircleFrameBitmapDisplayer implements BitmapDisplayer {
	...
	public CircleFrameBitmapDisplayer(int strokeWidth) {
		this(strokeWidth, 0);
	}

	public CircleFrameBitmapDisplayer(int strokeWidth, int marginPixels) {
	...
	public void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom loadedFrom) {
		...
		imageAware.setImageDrawable(new RoundedDrawable(bitmap, strokeWidth, margin));
	}
	...
	public static class RoundedDrawable extends Drawable {
		...
		public RoundedDrawable(Bitmap bitmap, int strokeWidth, int margin) {
			this.strokeWidth = strokeWidth;
			this.margin = margin;
...
//			canvas.drawRoundRect(mRect, cornerRadius, cornerRadius, paint);
			canvas.drawCircle(mRect.width()/2, mRect.height()/2, mRect.width()/2, paint);//画圆
	        paint.setFilterBitmap(true);
	        paint.setDither(true);
	        paint.setColor(Color.parseColor("#ecebf1"));   //白色边框
	        paint.setStyle(Paint.Style.STROKE);
	        /* 设置paint的外框宽度 */
	        paint.setStrokeWidth(strokeWidth);
	        canvas.drawCircle(mRect.width()/2, mRect.height()/2, mRect.height()/2 - strokeWidth, paint);
		}
	...
	@Override
    public void display(GifDrawable drawable, ImageAware imageAware, LoadedFrom loadedFrom) {
